 ...
 * 'intmax_t' and 'uintmax_t', since their format specifiers and other properties
 * are built into the language and their identity is therefore determined by
 * the compiler.
 *
...
#ifndef __BITS_MACROS_H_
#define __BITS_MACROS_H_
...
#error "HelenOS expects __SIZE_TYPE__ and __SIZE_MAX__ to be defined by the toolchain."
#endif

#if !defined(__PTRDIFF_TYPE__) || !defined(__PTRDIFF_MAX__)
#error "HelenOS expects __PTRDIFF_TYPE__ and __PTRDIFF_MAX__ to be defined by the toolchain."
#endif
...
#error "HelenOS expects __WINT_TYPE__ and __WINT_WIDTH__ to be defined by the toolchain."
#endif
...
#error "HelenOS expects __INTMAX_TYPE__ and __INTMAX_MAX__ to be defined by the toolchain."
#endif
...
#error "HelenOS expects __INTMAX_C or __INTMAX_C_SUFFIX__ to be defined by the toolchain."
#endif
